    ...
    <aside className="sidebar">
      ...
      <div className="connect-section">
        ...
        <div className="action-buttons">
          <a href="https://www.linkedin.com/in/victor-barbarosh-56a03743" className="action-btn" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://github.com/vBarbaros" className="action-btn" target="_blank" rel="noopener noreferrer">
            <svg className="platform-icon" viewBox="0 0 24 24" fill="currentColor">
